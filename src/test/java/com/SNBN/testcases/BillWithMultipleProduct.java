...
public class BillWithMultipleProduct extends TestBase {
	@Test
	public void MultipleProductsInSingleBill() throws InterruptedException {
		...
		String Num = (TestData.getProperty("BWMPnumberOfBills"));
		int numberOfBills = Integer.parseInt(Num);
		int k = 0;
		for (int i = 0; i < numberOfBills; i++) {
			String N = (TestData.getProperty("BWMPnumberOfProducts"));
			...
			for (int j = 0; j < numberOfProducts; j++) {
				String PNN = String.valueOf(j);
				ProductSearch.click();
				ProductSearch.sendKeys(TestData.getProperty("BWMPProductName")+PNN);

				WindowsElement ProductSelect = (WindowsElement) driver
						.findElementByName(OR.getProperty("ProductSelect"));
				ProductSelect.click();
				...
				WindowsElement Quantity = (WindowsElement) driver
						.findElementByAccessibilityId(OR.getProperty("Quantity"));
				Quantity.clear();
				Quantity.sendKeys(TestData.getProperty("BWMPProductQTY"));
